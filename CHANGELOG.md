...
### Fixed
- #38 fix switch services not appearing due to config flags being read from platform config instead of device config

## [2.1.1] - 2026-03-06

### Fixed
- #36 prevent NaN values from being written to Modbus holding registers

## [2.1.0] - 2026-01-25

### Added
- Device initialization retry mechanism with exponential backoff and 15-minute timeout
