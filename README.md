...
<img alt="Screenshot of the Home app showing the Airfi air handling unit accessory with option to Show as Separate Tiles for easier access." src="./images/setup.jpg">
